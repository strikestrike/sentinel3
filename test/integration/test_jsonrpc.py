...
def test_terracoind():
    ...
    genesis_hash = '00000000804bbc6a621a9dbb564ce469f492e1ccf2d70f8a6b241e26a277afa2'
    for line in config_text.split("\n"):
        if line.startswith('testnet=1'):
            network = 'testnet'
            is_testnet = True
            genesis_hash = '00000000a48f093611895d7452e456b646d213d238e86dc2c0db7d15fe6c555d'
